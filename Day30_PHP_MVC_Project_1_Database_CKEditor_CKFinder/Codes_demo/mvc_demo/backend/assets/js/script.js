...
$(document).ready(function () {
    //Tích hợp CKEditor vào textarea dựa vào thuộc tính name của textarea đó
    //Do trình duyệt có cơ chế cache với js, nên sẽ có trường hợp sự thay đổi, cần phải xóa cache trình duyệt: Ctrl + Shift + R
