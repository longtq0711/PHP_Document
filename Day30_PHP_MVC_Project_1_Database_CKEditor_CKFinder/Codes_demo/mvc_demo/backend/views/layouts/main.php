...
- Cách ghép layout từ template có sẵn:
    ...
    + Sửa lại các đường dẫn tới các file css, js, images, fonts,... theo đúng cấu trúc mô hình MVC của bạn
    + Hiển thị các thuộc tính động cho layout: tiêu đề trang, các thuộc tính seo, nội dung view động... lấy từ controller cha
    + Hiển thị tập trung tất cả các lỗi tại file layout: error, session error, session success...
    +
-->
...
<!--            Hiển thị lỗi validate nếu có dựa vào thuộc tính error-->
            ...
            <?php endif;?>
<!--            Hiển thị lỗi liên quan đến session dạng flassh-->
            ...
            <?php endif;?>
            <!--            Hiển thị thành công liên quan đến session dạng flassh-->
...
<!--Tích hợp js custom - file js của riêng bạn, đặt sau cùng các file js khác-->
