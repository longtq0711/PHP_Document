...
class Category{
    ...
    public function getConnection(){
        try {
            //Do cần sử dụng các hằng số trong class Database, cần nhúng file
    ...
    public function insertData(){
        ...
        //- Tạo câu truy vấn dưới dạng tham số để tránh lỗi bảo mật SQL Injection
        $sql_insert = "INSERT INTO categories(name, description) VALUES(:name, :description)";
        // - Chuẩn bị đối tượng truy vấn
        $obj_insert = $this->connection->prepare($sql_insert);
        // - Tạo mảng để truyền giá trị thật cho tham số trong câu truy vấn nếu có
        //Gúa trị thật đến từ chính thuộc tính của model
        $inserts = [
            ':name' => $this->name,
    ...
    public function getAll(){
        ...
        // - Bỏ qua bước tạo mảng vì câu truy vấn không có tham số nào
        // - Thực thi đối tượng truy vấn vừa tạo, với truy vấn SELECT k cần thao tác với kêt quả trả về
