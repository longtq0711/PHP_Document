...
<<<<<<< HEAD
 * Url sẽ xử lý ajax
 * Mục đích: truy vấn CSDL, lấy ra toàn bộ sản phẩm, trả về 1 bảng HTML chứa danh sách sản phẩm cho nơi gọi ajax
 *
 *
 */
// - Thử debug mảng $_POST hoặc $_GET dựa vào phương thức gửi dữ liệu truyền lên từ ajax
//echo "<pre>";
//print_r($_POST);
//echo "</pre>";
...
<!--Mặc định kiểu dữ liệu trả về cho ajax là text/html, nếu như ko khai báo kiểu dữ liệu trả về khi gọi ajax (json)-->
=======
